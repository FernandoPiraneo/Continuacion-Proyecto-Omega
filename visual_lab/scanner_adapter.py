...
def _build_visual_state_event(
    *,
    ...
    compressed_plans = build_plan_compression_views(
        trade_setups_by_tf=trade_setups_by_tf,
        primary_trade=primary_trade,
    ...
    return {
        ...
        "primary_trade": primary_trade,
        "fractal_trade_tree": fractal_trade_tree,
        "best_plan_by_tf": compressed_plans.get("best_plan_by_tf", {}),
        "chart_plan_overlays": compressed_plans.get("chart_plan_overlays", {}),
        "best_alerts_by_tf": compressed_plans.get("best_alerts_by_tf", {}),
        "candidate_plans_by_tf": compressed_plans.get("candidate_plans_by_tf", {}),
        "setups": setups,
